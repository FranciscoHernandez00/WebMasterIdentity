...
namespace WebMasterIdentity.Controllers
{
    ...
    public class TiendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TiendaId,NombreTienda,Direccion")] Tienda tienda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TiendaId,NombreTienda,Direccion")] Tienda tienda)
        {
